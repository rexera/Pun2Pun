...
PROMPT = f'''
{definition}
Please explain the mechanism of this pun. For homophonic puns, explain how the pronunciation is similar or identical. For homographic puns, explain how multiple meanings are formed from a single word.
'''
...
output_jsonl_path = f'output/{model}/explanation/{lan}_{type}_explanation_vanilla.jsonl'

if __name__ == "__main__":
    try:
        main(input_json_path, output_jsonl_path, batch_size=1, max_workers=1)
    except KeyboardInterrupt:
