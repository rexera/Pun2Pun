...
PROMPT = f'''
{definition}
Please identify where the pun is in this sentence. Only output the final answer without any explanation.
'''
...
output_jsonl_path = f'output/{model}/pun/{lan}_{type}_pun_vanilla.jsonl'

if __name__ == "__main__":
    try:
        main(input_json_path, output_jsonl_path, batch_size=10, max_workers=5)
    except KeyboardInterrupt:
