...
PROMPT = f'''
{definition}
请仔细思考，判断这一句是同音双关、同形双关，抑或不包含双关。同音双关输出phonic，同形双关输出graphic，不包含输出None。仅需要输出一个单词。
...
output_jsonl_path = f'output/{model}/tag/{lan}_{type}_tag_cot.jsonl'''

input_json_path = '/Users/mayiran/Projects/Pun2Pun/sankey/translation/r1/zh_graphic_translation_cvo.jsonl'
output_jsonl_path = '/Users/mayiran/Projects/Pun2Pun/sankey/tag/zh_graphic_to_en.jsonl'

if __name__ == "__main__":
    try:
        main(input_json_path, output_jsonl_path, batch_size=50, max_workers=50)
    except KeyboardInterrupt:
