...
PROMPT = f'''
{definition}
Please determine if this sentence contains a homophonic pun or a homographic pun. Output 'phonic' for homophonic puns and 'graphic' for homographic puns. Only output a single word without any explanation.
'''
...
output_jsonl_path = f'output/{model}/tag/{lan}_{type}_tag_vanilla.jsonl'
